...
Solve the pacific atlantic water flow problem efficiently.
...
3. **Data Structures**: Use sets for O(1) membership testing and deduplication
4. **Optimization**: Use appropriate algorithms for optimal complexity

## Implementation Details

- **Function Name**: `pacificAtlantic`
