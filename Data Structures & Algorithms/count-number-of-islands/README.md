...
Count or identify connected components (islands) in a grid.

### Example
```
Input: Grid with 0s and 1s
...
The solution uses **queue-based** to solve this problem efficiently.
