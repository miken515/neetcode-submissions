...
Design a class to find the kth largest element in a stream. You can assume k is always valid.

Example:
- Stream: [4, 1, 3, 3, 5, 4, 6, 13]
- k = 3
- For each new number, return the 3rd largest
